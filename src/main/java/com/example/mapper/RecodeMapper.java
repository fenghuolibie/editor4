...
public interface RecodeMapper {
     ...
     * @return 1代表存在
     */
    int selectUserByDate(@Param("uid") int uid, @Param("theDay") String theDay);
     ...
     * @return
     */
    List<Recode> selectUserRecodeByName7days(@Param("userName") String userName, @Param("theDay") String theDay);
     ...
     * @return
     */
    List<DateByWeekDTO> selectUserRecodeByMonth(@Param("userName") String userName, @Param("theDay") String theDay);
